...
navbtns_info = [{'name': '[<', 'hint': 'Home - hot key, go to first frame', 'func': scroll_to_start},{'name': '<<', 'hint': 'PageDown - hot key, fast scroll backward', 'func': scroll_fast_prev},{'name': ' <', 'hint': 'Shift+PageDown - shortcut, scroll backward by frame', 'func': scroll_prev_by_frame},{'name': ' >', 'hint': 'Shift+PageUp - shortcut, scroll forward by frame', 'func': scroll_forward_by_frame},{'name': '>>', 'hint': 'PageUp - hot key,fast scroll forward', 'func': scroll_fast_forward},{'name': '  >]', 'hint': 'End - hot key, go to last frame', 'func': scroll_to_end},{'name': 'R+', 'hint': 'rotate the keys clockwise, hot key +', 'func': rotate_cw},{'name': 'R-', 'hint': 'rotate the keys counterclockwise, hot key -', 'func': rotate_ccw}]
...
extra_label3 = GLLabel(6, 90, '''to select the key press ctrl + left mouse button on the key rect.to deselect the key press ctrl + left mouse button on empty space.''')
